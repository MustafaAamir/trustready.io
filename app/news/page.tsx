...
const featuredArticle = {
  ...
  excerpt:
    "As AI adoption accelerates, new regulations are emerging globally. Learn how to prepare your compliance strategy for AI governance requirements.",
  author: "Sarah Chen",
  date: "August 15, 2025",
  readTime: "8 min read",
...
const newsArticles = [
  {
    ...
    excerpt:
      "The AICPA has released updated guidance for SOC 2 Type II audits, focusing on enhanced security controls and cloud-native architectures.",
  ...
  },
  {
    ...
    excerpt:
      "European regulators continue aggressive enforcement with record-breaking fines. Here's what your organization needs to know to stay compliant.",
  ...
  },
  {
    ...
    excerpt:
      "Organizations still operating under ISO 27001:2013 have until September 2025 to complete their transition. Don't get caught unprepared.",
    author: "David Park",
    date: "August 8, 2025",
    readTime: "4 min read",
    category: "ISO 27001",
  ...
  },
  {
    ...
    excerpt:
      "New HHS report shows alarming increase in healthcare data breaches. HIPAA compliance strategies need immediate attention.",
  ...
  },
  {
    ...
    excerpt:
      "New study reveals companies using compliance automation see 300% ROI within 18 months. Here's how to build your business case.",
  ...
  },
  {
    ...
    excerpt:
      "Growing companies often struggle with compliance requirements. Our comprehensive checklist helps you prioritize and plan effectively.",
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        >
          ...
          <p className="text-xl max-w-3xl mx-auto leading-relaxed">
            ...
            and expert insights to keep your organization ahead of the curve.
          </p>
        </motion.div>
      </section>
            ...
            <Card className="overflow-hidden">
              <div className="md:flex">
                ...
                <div className="md:w-1/2 p-8">
                  <Badge className="mb-3 hover:bg-blue-700">Featured</Badge>
                  ...
                  <div className="flex items-center text-sm mb-6 gap-4">
